...
if method == 'HA':
    ...
    for i in range(len(testX)):
        ...
        a1 = np.mean(a[0:pre_len-1], axis=0)
        if i==1:
            print(a1.shape)
        result.append(a1)
    ...
    print(testY1.shape[0],result1.shape)

  # //  testY1=testY1[0:testY1.shape[0]:3]+testY1[1:testY1.shape[0]:3]+testY1[2:testY1.shape[0]:3]

    # print(testY1)
    # rmse, mae, accuracy,r2,var = evaluation(testY1[0:testY1.shape[0]:pre_len], result1)
    # print('10min-HA_rmse:%r'%rmse,
    #       'HA_mae:%r'%mae,
    #       'HA_acc:%r'%accuracy,
    #       'HA_r2:%r'%r2,
    #       'HA_var:%r'%var)
    # rmse, mae, accuracy,r2,var = evaluation(testY1[1:testY1.shape[0]:pre_len], result1)
    # print('20min-HA_rmse:%r'%rmse,
    #       'HA_mae:%r'%mae,
    #       'HA_acc:%r'%accuracy,
    #       'HA_r2:%r'%r2,
    #       'HA_var:%r'%var)
    rmse, mae, accuracy,r2,var = evaluation(testY1[2:testY1.shape[0]:pre_len], result1)
    print('min-HA_rmse:%r'%rmse,
          'HA_mae:%r'%mae,
          'HA_acc:%r'%accuracy,
          'HA_r2:%r'%r2,
          'HA_var:%r'%var)
...
if method == 'ARIMA':
    print(data.shape)
    rng = pd.date_range('1/11/2018', periods=2158, freq='15min')
