...
def load_beijing_data(dataset):
    beijing_adj = pd.read_csv(r'data/beijing_adj.csv',header=None)
    adj = np.mat(beijing_adj)
    beiing_tf = pd.read_csv(r'data/beijing_speed.csv')
    return beiing_tf, adj
