...
//            System.out.println(m.getUserId());
    	...
    	{
    		//System.out.print( "head" + SequenceDataset.userIdList.get(i));
    		...
    		for(int j=0;j<KList.size();j++)
    		{
    			...
    			utils.genreateOutputFiles("LJB" + adj[i][j], "C:\\Users\\gorgen\\Desktop\\S3HMM\\result.txt");
    		}
    		//System.out.println(" ");
...
//            sum_time=sum_time + t;
	...
	//                    System.out.println(candidate.size() + " -");
        ...
        for (int j = 0; j < KList.size(); j++){
        	accuracyList.add((double) numCorrectK[j] / (double) mdb.size());
//    		System.out.println("hellof" + KList.size());
        }
